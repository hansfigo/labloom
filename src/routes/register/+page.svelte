...
<div
	class=" relative flex h-screen oveFrflow-hidden justify-center text items-center bg-blue-700/80"
>
	{#if ready}
		<div
		...
		>
			<form use:enhance action="?/register" method="post" class="section-left">
